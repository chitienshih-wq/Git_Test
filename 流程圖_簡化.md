...
flowchart TD
    ...
    PrepareTask --> AskAI[請人工智慧分析<br/>提示詞：分析股價趨勢和技術指標<br/>撰寫詳細且細緻的分析報告<br/>不要只說趨勢混合，要提供深入見解<br/>報告結尾需附Markdown表格整理重點]
...
flowchart TD
    ...
    GetInfo --> PrepareTask[準備分析任務<br/>提示詞：分析過去一週的社交媒體貼文<br/>公司新聞和市場情緒<br/>搜尋所有可能的資料來源<br/>包含社交媒體、情緒數據、新聞等]
    
    PrepareTask --> AskAI[請人工智慧分析<br/>提示詞：撰寫詳細的長篇報告<br/>分析人們對公司的看法<br/>分析每日市場情緒數據<br/>檢視最近的公司新聞<br/>提供詳細且細緻的分析見解<br/>報告結尾需附Markdown表格整理重點]
...
```mermaid
flowchart TD
    Start([所有分析師完成報告]) --> BullResearcher[看多研究員<br/>提示詞：找出支持買進的理由<br/>強調成長潛力、競爭優勢<br/>正面市場指標<br/>反駁看空論點]
    
    BullResearcher --> CheckRounds{辯論次數足夠了嗎?}
    
    CheckRounds -->|不夠| BearResearcher[看空研究員<br/>提示詞：找出支持賣出的理由<br/>強調風險、挑戰<br/>負面市場指標<br/>反駁看多論點]
    CheckRounds -->|足夠| ResearchManager[研究經理<br/>提示詞：評估辯論並做出明確決策<br/>總結雙方關鍵論點<br/>制定詳細投資計劃<br/>考慮過去錯誤經驗]
...
flowchart TD
    ...
    Analyze --> AskAI[請人工智慧做出交易決策<br/>提示詞：基於分析師團隊的全面分析<br/>檢視投資計劃和所有報告<br/>利用過去決策的經驗教訓<br/>提供具體建議：買進、賣出或持有<br/>必須以「最終交易建議：買進/賣出/持有」結尾]
...
```mermaid
flowchart TD
    Start([風險管理團隊收到交易建議]) --> RiskyAnalyst[積極風險分析師<br/>提示詞：評估高風險高報酬可能性<br/>強調大膽策略和競爭優勢<br/>質疑保守和中性觀點<br/>用數據反駁對立觀點]
    
    RiskyAnalyst --> CheckRounds{討論次數足夠了嗎?}
    
    CheckRounds -->|不夠| SafeAnalyst[保守風險分析師<br/>提示詞：評估低風險穩健可能性<br/>強調保護資產和最小化波動<br/>質疑積極和中性觀點<br/>指出潛在威脅和風險]
    CheckRounds -->|足夠| RiskJudge[風險評估官<br/>提示詞：評估三位分析師的辯論<br/>總結關鍵論點<br/>考慮過去錯誤經驗<br/>做出明確決策：買進、賣出或持有]
    
    SafeAnalyst --> CheckRounds2{討論次數足夠了嗎?}
    
    CheckRounds2 -->|不夠| NeutralAnalyst[中性風險分析師<br/>提示詞：評估平衡風險可能性<br/>權衡利弊得失<br/>質疑積極和保守觀點<br/>提倡平衡策略]
