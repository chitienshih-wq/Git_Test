...
flowchart TD
    ...
    GetInfo --> PrepareTask[準備分析任務<br/>選擇最相關的技術指標<br/>最多選擇8個互補的指標<br/>包含移動平均線、MACD<br/>RSI、布林通道<br/>ATR、成交量指標等]
    
    PrepareTask --> AskAI[請人工智慧分析<br/>分析股價趨勢和技術指標<br/>撰寫詳細且細緻的分析報告<br/>不要只說趨勢混合<br/>要提供深入見解<br/>報告結尾需附Markdown表格]
...
flowchart TD
    ...
    GetInfo --> PrepareTask[準備分析任務<br/>分析過去一週的社交媒體<br/>公司新聞和市場情緒<br/>搜尋所有可能的資料來源<br/>包含社交媒體、情緒數據、<br/>新聞等]
    
    PrepareTask --> AskAI[請人工智慧分析<br/>撰寫詳細的長篇報告<br/>分析人們對公司的看法<br/>分析每日市場情緒數據<br/>檢視最近的公司新聞<br/>提供詳細且細緻的分析見解<br/>報告結尾需附Markdown表格]
...
```mermaid
flowchart TD
    Start([所有分析師完成報告]) --> BullResearcher[看多研究員<br/>找出買進理由<br/>強調成長和優勢<br/>反駁看空論點]
    
    BullResearcher --> CheckRounds{辯論次數足夠了嗎?}
    
    CheckRounds -->|不夠| BearResearcher[看空研究員<br/>找出賣出理由<br/>強調風險和挑戰<br/>反駁看多論點]
    CheckRounds -->|足夠| ResearchManager[研究經理<br/>評估辯論<br/>總結關鍵論點<br/>制定投資計劃<br/>考慮過去經驗]
...
flowchart TD
    ...
    Analyze --> AskAI[請人工智慧做出交易決策<br/>基於分析師團隊的全面分析<br/>檢視投資計劃和所有報告<br/>利用過去決策的經驗教訓<br/>提供具體建議：<br/>買進、賣出或持有<br/>必須以「最終交易建議」結尾]
...
```mermaid
flowchart TD
    Start([風險管理團隊收到交易建議]) --> RiskyAnalyst[積極風險分析師<br/>評估高風險高報酬<br/>強調大膽策略<br/>質疑保守觀點<br/>用數據反駁]
    
    RiskyAnalyst --> CheckRounds{討論次數足夠了嗎?}
    
    CheckRounds -->|不夠| SafeAnalyst[保守風險分析師<br/>評估低風險穩健<br/>強調保護資產<br/>質疑積極觀點<br/>指出潛在風險]
    CheckRounds -->|足夠| RiskJudge[風險評估官<br/>評估辯論<br/>總結關鍵論點<br/>考慮過去經驗<br/>做出明確決策]
    
    SafeAnalyst --> CheckRounds2{討論次數足夠了嗎?}
    
    CheckRounds2 -->|不夠| NeutralAnalyst[中性風險分析師<br/>評估平衡風險<br/>權衡利弊得失<br/>質疑兩極觀點<br/>提倡平衡策略]
...
flowchart TD
    ...
    AnalystPhase --> Market[市場分析師<br/>選擇技術指標<br/>分析股價趨勢]
    Market --> Social[社交媒體分析師<br/>分析社交媒體<br/>市場情緒和新聞]
    Social --> News[新聞分析師<br/>分析全球新聞<br/>宏觀經濟指標]
    News --> Fund[財務分析師<br/>分析公司基本面<br/>財務文件和歷史]
    
    Fund --> ResearchPhase[研究團隊階段]
    
    ResearchPhase --> Bull[看多研究員<br/>找出買進理由<br/>強調成長和優勢]
    Bull --> Bear[看空研究員<br/>找出賣出理由<br/>強調風險和挑戰]
    Bear --> Bull
    Bull --> Manager[研究經理<br/>評估辯論<br/>制定投資計劃]
    
    Manager --> TraderPhase[交易員階段]
    
    TraderPhase --> Trader[交易員<br/>基於計劃和報告<br/>做出交易決策]
    
    Trader --> RiskPhase[風險管理階段]
    
    RiskPhase --> Risky[積極風險分析師<br/>評估高風險高報酬]
    Risky --> Safe[保守風險分析師<br/>評估低風險穩健]
    Safe --> Neutral[中性風險分析師<br/>評估平衡風險]
    Neutral --> Risky
    Risky --> Judge[風險評估官<br/>評估辯論<br/>做出最終決策]
